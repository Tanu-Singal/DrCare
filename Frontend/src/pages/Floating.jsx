    ...
    <>
      ...
      {open && (
        <div className="fixed bottom-20 right-4 w-[95%] sm:w-[90%] md:w-[800px] h-[85vh] max-h-[90vh] 
          ...
          {/* Sidebar */}
          <div className="w-full sm:w-1/3 h-1/3 sm:h-full overflow-y-auto border-b sm:border-b-0 sm:border-r border-gray-700 
                          bg-gradient-to-b from-[#1e293b] to-[#0f172a]">
            <Sidebar startNewChat={() => setMessages([])} />
          </div>

          {/* Chat */}
          <div className="w-full sm:w-2/3 h-2/3 sm:h-full overflow-hidden flex flex-col bg-[#0f172a]">
